...
ALLOWED_CLIENT_HOSTS = os.environ.get("ALLOWED_CLIENT_HOSTS", "localhost,127.0.0.1,comercio5.herokuapp.com")
...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://root:nano@localhost:5432/saleor", conn_max_age=600
    )
}
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,comercio5.herokuapp.com"))
